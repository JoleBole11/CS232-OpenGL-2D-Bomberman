...
public:
	...
	void set_line(bool visible) { primitive.line_visibility = visible; }

	glm::vec3 get_fill() const { return primitive.fill; }
	void set_fill(const glm::vec3& new_fill) { primitive.fill = new_fill; }
	void set_fill(bool visible) { primitive.fill_visibility = visible; }
